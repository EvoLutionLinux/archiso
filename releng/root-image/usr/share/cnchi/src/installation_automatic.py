...
class InstallationAutomatic(Gtk.Box):
    ...
    def translate_ui(self):
        ...
        txt = _("Select the drive we should use to install Arch " \
    ...
    def start_installation(self):
        ...
        logging.info(_("Fu-rch will install Arch on %s") % self.auto_device)      
        ...
        if self.settings.get('install_bootloader'):
            ...
            logging.info(_("Fu-rch will install the %s bootloader on %s") % \
                (self.settings.get('bootloader_type'), self.settings.get('bootloader_device')))
        else:
            logging.warning("Fu-rch will not install any boot loader")
