...
# Lution installation using aria2.
...
if __name__ == '__main__':
    ...
    ["haveged", "crda", "ipw2200-fw", "ipw2100-fw", "zd1211-firmware",
     ...
     "pkgfile", "firefox", "flashplugin", "alsa-utils", "whois", "dnsutils", 
     "transmission-cli", "libreoffice-installer", "faenza-hotot-icon", 
     "faenza-icon-theme", "unzip", "unrar", 
    ...
    ["base", "base-devel",
     ...
     "pacmanxg4", "pkgfile", "firefox", "flashplugin", "alsa-utils",
     "whois", "dnsutils", "transmission-cli", "libreoffice-installer",
     "faenza-hotot-icon", "faenza-icon-theme",
