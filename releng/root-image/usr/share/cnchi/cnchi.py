...
_desktops = [ "nox", "gnome", "cinnamon", "xfce", "openbox", "lxde" ]
...
class Main(Gtk.Window):
    ...
    def __init__(self):
        ...
        self.set_title(_('Arch Linux Installer'))
...
if __name__ == '__main__':
    ...
    if _update:
        ...
        if upd.update():
            ...
            # instance of Cnchi
            # p = "/tmp/.setup-running"
            # p = "/usr/share/cnchi/data/packages.xml/.setup-running"
            p = "/tmp/.setup-running"
            if os.path.exists(p):
                os.remove(p)
